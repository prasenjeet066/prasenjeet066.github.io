...
export default function Content() {
  ...
  return (
    <div className='p-6'>
    <div className="w-full h-full flex flex-col md:flex-row items-center gap-8 px-4 md:px-12 py-6 bg-indigo-100 rounded-xl">
...
<figure className="max-w-screen-md mx-auto text-center">
    ...
    <blockquote>
        <p className="text-2xl italic font-medium text-gray-900 dark:text-white font-['Lora']">{details.slice(0,250)+" ....."}</p>
    </blockquote>
